...
// string extend = 9;
inline void GroupChat::clear_extend() {
  extend_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& GroupChat::extend() const {
  // @@protoc_insertion_point(field_get:im.GroupChat.extend)
  return extend_.GetNoArena();
}
inline void GroupChat::set_extend(const ::std::string& value) {
  
  extend_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.GroupChat.extend)
}
#if LANG_CXX11
inline void GroupChat::set_extend(::std::string&& value) {
  
  extend_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.GroupChat.extend)
}
#endif
inline void GroupChat::set_extend(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  extend_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.GroupChat.extend)
}
inline void GroupChat::set_extend(const char* value, size_t size) {
  
  extend_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.GroupChat.extend)
}
inline ::std::string* GroupChat::mutable_extend() {
  
  // @@protoc_insertion_point(field_mutable:im.GroupChat.extend)
  return extend_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* GroupChat::release_extend() {
  // @@protoc_insertion_point(field_release:im.GroupChat.extend)
  
  return extend_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void GroupChat::set_allocated_extend(::std::string* extend) {
  if (extend != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:im.GroupChat.extend)
}
