...
public:
	...
	static int8_t ReadInt8(uchar_t* buf);
	static uint8_t ReadUint8(uchar_t* buf);
	...
	static void WriteInt8(uchar_t* buf, int8_t data);
	static void WriteUint8(uchar_t* buf, uint8_t data);	
	...
	static void WriteFixedLengthString(uchar_t* buf, const char* str, uint32_t len);
	...
	void ReadFixedLengthString(string& str, uint32_t len);
