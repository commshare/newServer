...
class RadioChatDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<RadioChat>
      _instance;
} _RadioChat_default_instance_;
class RadioChatAckDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<RadioChatAck>
      _instance;
} _RadioChatAck_default_instance_;
class RadioCancelChatDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<RadioCancelChat>
      _instance;
...
static void InitDefaultsRadioChat() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::im::_RadioChat_default_instance_;
    new (ptr) ::im::RadioChat();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::im::RadioChat::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<0> scc_info_RadioChat =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsRadioChat}, {}};

static void InitDefaultsRadioChatAck() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::im::_RadioChatAck_default_instance_;
    new (ptr) ::im::RadioChatAck();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::im::RadioChatAck::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<0> scc_info_RadioChatAck =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsRadioChatAck}, {}};

static void InitDefaultsRadioCancelChat() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::im::_RadioCancelChat_default_instance_;
    new (ptr) ::im::RadioCancelChat();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::im::RadioCancelChat::InitAsDefaultInstance();
}

::google::protobuf::internal::SCCInfo<0> scc_info_RadioCancelChat =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsRadioCancelChat}, {}};
...
void InitDefaults() {
  ...
  ::google::protobuf::internal::InitSCC(&scc_info_RadioChat.base);
  ::google::protobuf::internal::InitSCC(&scc_info_RadioChatAck.base);
  ::google::protobuf::internal::InitSCC(&scc_info_RadioCancelChat.base);
}
...
const int MESAddFriend::kSOperIdFieldNumber;
...
const int MESJoinGrp::kSOperIdFieldNumber;
...
MESGrpChat::MESGrpChat(const MESGrpChat& from)
  ...
  ::memcpy(&nnotifycount_, &from.nnotifycount_,
    ...
    reinterpret_cast<char*>(&nnotifycount_)) + sizeof(msgtype_));
...
void MESGrpChat::SerializeWithCachedSizes(
  ...
  // uint32 msgType = 10;
  if (this->msgtype() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(10, this->msgtype(), output);
  }
...
GroupChatAck::GroupChatAck()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_im_2emes_2eproto::scc_info_GroupChatAck.base);
  SharedCtor();
...
const GroupChatAck& GroupChatAck::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_im_2emes_2eproto::scc_info_GroupChatAck.base);
  return *internal_default_instance();
}
...
GroupChatCancel::GroupChatCancel()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_im_2emes_2eproto::scc_info_GroupChatCancel.base);
  SharedCtor();
...
const GroupChatCancel& GroupChatCancel::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_im_2emes_2eproto::scc_info_GroupChatCancel.base);
  return *internal_default_instance();
}
...
GroupChatCancelAck::GroupChatCancelAck()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_im_2emes_2eproto::scc_info_GroupChatCancelAck.base);
  SharedCtor();
...
const GroupChatCancelAck& GroupChatCancelAck::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_im_2emes_2eproto::scc_info_GroupChatCancelAck.base);
  return *internal_default_instance();
}
...
void RadioChat::InitAsDefaultInstance() {
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int RadioChat::kSFromIdFieldNumber;
const int RadioChat::kSRadioIdFieldNumber;
const int RadioChat::kSMsgIdFieldNumber;
const int RadioChat::kMsgTimeFieldNumber;
const int RadioChat::kEncryptFieldNumber;
const int RadioChat::kSContentFieldNumber;
const int RadioChat::kExtendFieldNumber;
const int RadioChat::kSIdFieldNumber;
const int RadioChat::kSToIdFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

RadioChat::RadioChat()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_im_2emes_2eproto::scc_info_RadioChat.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:im.RadioChat)
}
RadioChat::RadioChat(const RadioChat& from)
  : ::google::protobuf::MessageLite(),
      _internal_metadata_(NULL) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  sfromid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ...
  ::memcpy(&msgtime_, &from.msgtime_,
    static_cast<size_t>(reinterpret_cast<char*>(&encrypt_) -
    reinterpret_cast<char*>(&msgtime_)) + sizeof(encrypt_));
  // @@protoc_insertion_point(copy_constructor:im.RadioChat)
}

void RadioChat::SharedCtor() {
  sfromid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  sradioid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  smsgid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  scontent_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
RadioChat::~RadioChat() {
  // @@protoc_insertion_point(destructor:im.RadioChat)
  SharedDtor();
}

void RadioChat::SharedDtor() {
  sfromid_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
void RadioChat::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const RadioChat& RadioChat::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_im_2emes_2eproto::scc_info_RadioChat.base);
  return *internal_default_instance();
}


void RadioChat::Clear() {
// @@protoc_insertion_point(message_clear_start:im.RadioChat)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
bool RadioChat::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::LiteUnknownFieldSetter unknown_fields_setter(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:im.RadioChat)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:im.RadioChat)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:im.RadioChat)
  return false;
#undef DO_
}

void RadioChat::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:im.RadioChat)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  output->WriteRaw((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).data(),
                   static_cast<int>((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).size()));
  // @@protoc_insertion_point(serialize_end:im.RadioChat)
}

size_t RadioChat::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:im.RadioChat)
  size_t total_size = 0;
...
void RadioChat::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const RadioChat*>(&from));
}

void RadioChat::MergeFrom(const RadioChat& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:im.RadioChat)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void RadioChat::CopyFrom(const RadioChat& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:im.RadioChat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RadioChat::IsInitialized() const {
  return true;
}

void RadioChat::Swap(RadioChat* other) {
  if (other == this) return;
  InternalSwap(other);
}
void RadioChat::InternalSwap(RadioChat* other) {
  using std::swap;
  sfromid_.Swap(&other->sfromid_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
::std::string RadioChat::GetTypeName() const {
  return "im.RadioChat";
}
...
void RadioChatAck::InitAsDefaultInstance() {
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int RadioChatAck::kSFromIdFieldNumber;
const int RadioChatAck::kSRadioIdFieldNumber;
const int RadioChatAck::kSMsgIdFieldNumber;
const int RadioChatAck::kMsgTimeFieldNumber;
const int RadioChatAck::kErrcodeFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

RadioChatAck::RadioChatAck()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_im_2emes_2eproto::scc_info_RadioChatAck.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:im.RadioChatAck)
}
RadioChatAck::RadioChatAck(const RadioChatAck& from)
  : ::google::protobuf::MessageLite(),
      _internal_metadata_(NULL) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  sfromid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ...
  ::memcpy(&msgtime_, &from.msgtime_,
    static_cast<size_t>(reinterpret_cast<char*>(&errcode_) -
    reinterpret_cast<char*>(&msgtime_)) + sizeof(errcode_));
  // @@protoc_insertion_point(copy_constructor:im.RadioChatAck)
}

void RadioChatAck::SharedCtor() {
  sfromid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  sradioid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  smsgid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ::memset(&msgtime_, 0, static_cast<size_t>(
...
RadioChatAck::~RadioChatAck() {
  // @@protoc_insertion_point(destructor:im.RadioChatAck)
  SharedDtor();
}

void RadioChatAck::SharedDtor() {
  sfromid_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  sradioid_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  smsgid_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}

void RadioChatAck::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const RadioChatAck& RadioChatAck::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_im_2emes_2eproto::scc_info_RadioChatAck.base);
  return *internal_default_instance();
}


void RadioChatAck::Clear() {
// @@protoc_insertion_point(message_clear_start:im.RadioChatAck)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
bool RadioChatAck::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::LiteUnknownFieldSetter unknown_fields_setter(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:im.RadioChatAck)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:im.RadioChatAck)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:im.RadioChatAck)
  return false;
#undef DO_
}

void RadioChatAck::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:im.RadioChatAck)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  output->WriteRaw((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).data(),
                   static_cast<int>((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).size()));
  // @@protoc_insertion_point(serialize_end:im.RadioChatAck)
}

size_t RadioChatAck::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:im.RadioChatAck)
  size_t total_size = 0;
...
void RadioChatAck::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const RadioChatAck*>(&from));
}

void RadioChatAck::MergeFrom(const RadioChatAck& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:im.RadioChatAck)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void RadioChatAck::CopyFrom(const RadioChatAck& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:im.RadioChatAck)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RadioChatAck::IsInitialized() const {
  return true;
}

void RadioChatAck::Swap(RadioChatAck* other) {
  if (other == this) return;
  InternalSwap(other);
}
void RadioChatAck::InternalSwap(RadioChatAck* other) {
  using std::swap;
  sfromid_.Swap(&other->sfromid_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  sradioid_.Swap(&other->sradioid_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
...
::std::string RadioChatAck::GetTypeName() const {
  return "im.RadioChatAck";
}


// ===================================================================

void RadioCancelChat::InitAsDefaultInstance() {
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
const int RadioCancelChat::kSFromIdFieldNumber;
const int RadioCancelChat::kSRadioIdFieldNumber;
const int RadioCancelChat::kSMsgIdFieldNumber;
const int RadioCancelChat::kMsgTimeFieldNumber;
const int RadioCancelChat::kExtendFieldNumber;
const int RadioCancelChat::kSToIdFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

RadioCancelChat::RadioCancelChat()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_im_2emes_2eproto::scc_info_RadioCancelChat.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:im.RadioCancelChat)
}
RadioCancelChat::RadioCancelChat(const RadioCancelChat& from)
  : ::google::protobuf::MessageLite(),
      _internal_metadata_(NULL) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  sfromid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ...
  // @@protoc_insertion_point(copy_constructor:im.RadioCancelChat)
}

void RadioCancelChat::SharedCtor() {
  sfromid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  sradioid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  smsgid_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  extend_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
RadioCancelChat::~RadioCancelChat() {
  // @@protoc_insertion_point(destructor:im.RadioCancelChat)
  SharedDtor();
}

void RadioCancelChat::SharedDtor() {
  sfromid_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  sradioid_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  smsgid_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  extend_.DestroyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
...
void RadioCancelChat::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const RadioCancelChat& RadioCancelChat::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_im_2emes_2eproto::scc_info_RadioCancelChat.base);
  return *internal_default_instance();
}


void RadioCancelChat::Clear() {
// @@protoc_insertion_point(message_clear_start:im.RadioCancelChat)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
bool RadioCancelChat::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::internal::LiteUnknownFieldSetter unknown_fields_setter(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:im.RadioCancelChat)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:im.RadioCancelChat)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:im.RadioCancelChat)
  return false;
#undef DO_
}

void RadioCancelChat::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:im.RadioCancelChat)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  output->WriteRaw((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).data(),
                   static_cast<int>((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).size()));
  // @@protoc_insertion_point(serialize_end:im.RadioCancelChat)
}

size_t RadioCancelChat::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:im.RadioCancelChat)
  size_t total_size = 0;
...
void RadioCancelChat::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const RadioCancelChat*>(&from));
}

void RadioCancelChat::MergeFrom(const RadioCancelChat& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:im.RadioCancelChat)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void RadioCancelChat::CopyFrom(const RadioCancelChat& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:im.RadioCancelChat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RadioCancelChat::IsInitialized() const {
  return true;
}

void RadioCancelChat::Swap(RadioCancelChat* other) {
  if (other == this) return;
  InternalSwap(other);
}
void RadioCancelChat::InternalSwap(RadioCancelChat* other) {
  using std::swap;
  sfromid_.Swap(&other->sfromid_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  sradioid_.Swap(&other->sradioid_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
...
::std::string RadioCancelChat::GetTypeName() const {
  return "im.RadioCancelChat";
}
...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::im::RadioChat* Arena::CreateMaybeMessage< ::im::RadioChat >(Arena* arena) {
  return Arena::CreateInternal< ::im::RadioChat >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::im::RadioChatAck* Arena::CreateMaybeMessage< ::im::RadioChatAck >(Arena* arena) {
  return Arena::CreateInternal< ::im::RadioChatAck >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::im::RadioCancelChat* Arena::CreateMaybeMessage< ::im::RadioCancelChat >(Arena* arena) {
  return Arena::CreateInternal< ::im::RadioCancelChat >(arena);
}
}  // namespace protobuf
}  // namespace google
