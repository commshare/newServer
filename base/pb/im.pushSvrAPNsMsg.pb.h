...
class PSvrMsg : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:im.PSvrMsg) */ {
 public:
  ...
  // string scallId = 13;
  void clear_scallid();
  static const int kScallIdFieldNumber = 13;
  ...
  static const int kEDiveceTypeFieldNumber = 11;
  ::im::DiveceType edivece_type() const;
  void set_edivece_type(::im::DiveceType value);

  // uint32 callType = 12;
  void clear_calltype();
  static const int kCallTypeFieldNumber = 12;
...
// .im.DiveceType eDivece_type = 11;
inline void PSvrMsg::clear_edivece_type() {
  edivece_type_ = 0;
}
inline ::im::DiveceType PSvrMsg::edivece_type() const {
  // @@protoc_insertion_point(field_get:im.PSvrMsg.eDivece_type)
  return static_cast< ::im::DiveceType >(edivece_type_);
}
inline void PSvrMsg::set_edivece_type(::im::DiveceType value) {
  
  edivece_type_ = value;
  // @@protoc_insertion_point(field_set:im.PSvrMsg.eDivece_type)
}

// uint32 callType = 12;
inline void PSvrMsg::clear_calltype() {
  calltype_ = 0u;
}
inline ::google::protobuf::uint32 PSvrMsg::calltype() const {
  // @@protoc_insertion_point(field_get:im.PSvrMsg.callType)
  return calltype_;
}
inline void PSvrMsg::set_calltype(::google::protobuf::uint32 value) {
  
  calltype_ = value;
  // @@protoc_insertion_point(field_set:im.PSvrMsg.callType)
}

// string scallId = 13;
inline void PSvrMsg::clear_scallid() {
  scallid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& PSvrMsg::scallid() const {
  // @@protoc_insertion_point(field_get:im.PSvrMsg.scallId)
  return scallid_.GetNoArena();
}
inline void PSvrMsg::set_scallid(const ::std::string& value) {
  
  scallid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.PSvrMsg.scallId)
}
#if LANG_CXX11
inline void PSvrMsg::set_scallid(::std::string&& value) {
  
  scallid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.PSvrMsg.scallId)
}
#endif
inline void PSvrMsg::set_scallid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  scallid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.PSvrMsg.scallId)
}
inline void PSvrMsg::set_scallid(const char* value, size_t size) {
  
  scallid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.PSvrMsg.scallId)
}
inline ::std::string* PSvrMsg::mutable_scallid() {
  
  // @@protoc_insertion_point(field_mutable:im.PSvrMsg.scallId)
  return scallid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* PSvrMsg::release_scallid() {
  // @@protoc_insertion_point(field_release:im.PSvrMsg.scallId)
  
  return scallid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void PSvrMsg::set_allocated_scallid(::std::string* scallid) {
  if (scallid != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:im.PSvrMsg.scallId)
}
