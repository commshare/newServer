...
class RadioCancelChat;
class RadioCancelChatDefaultTypeInternal;
extern RadioCancelChatDefaultTypeInternal _RadioCancelChat_default_instance_;
class RadioChat;
class RadioChatDefaultTypeInternal;
extern RadioChatDefaultTypeInternal _RadioChat_default_instance_;
class RadioChatAck;
class RadioChatAckDefaultTypeInternal;
extern RadioChatAckDefaultTypeInternal _RadioChatAck_default_instance_;
class UserKey;
...
template<> ::im::RadioCancelChat* Arena::CreateMaybeMessage<::im::RadioCancelChat>(Arena*);
template<> ::im::RadioChat* Arena::CreateMaybeMessage<::im::RadioChat>(Arena*);
template<> ::im::RadioChatAck* Arena::CreateMaybeMessage<::im::RadioChatAck>(Arena*);
...
class MESGrpChat : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:im.MESGrpChat) */ {
 public:
  ...
  // string sToId = 11;
  void clear_stoid();
  static const int kSToIdFieldNumber = 11;
  const ::std::string& stoid() const;
  void set_stoid(const ::std::string& value);
  #if LANG_CXX11
  void set_stoid(::std::string&& value);
...
class RadioChat : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:im.RadioChat) */ {
 public:
  RadioChat();
  virtual ~RadioChat();

  RadioChat(const RadioChat& from);

  inline RadioChat& operator=(const RadioChat& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  RadioChat(RadioChat&& from) noexcept
    : RadioChat() {
    *this = ::std::move(from);
  }

  inline RadioChat& operator=(RadioChat&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const RadioChat& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RadioChat* internal_default_instance() {
    return reinterpret_cast<const RadioChat*>(
               &_RadioChat_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    51;

  void Swap(RadioChat* other);
  friend void swap(RadioChat& a, RadioChat& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline RadioChat* New() const final {
    return CreateMaybeMessage<RadioChat>(NULL);
  }

  RadioChat* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RadioChat>(arena);
  }
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    final;
  void CopyFrom(const RadioChat& from);
  void MergeFrom(const RadioChat& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(RadioChat* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // string sRadioId = 2;
  void clear_sradioid();
  static const int kSRadioIdFieldNumber = 2;
  ...
  // string sToId = 9;
  void clear_stoid();
  static const int kSToIdFieldNumber = 9;
  const ::std::string& stoid() const;
  void set_stoid(const ::std::string& value);
  #if LANG_CXX11
  void set_stoid(::std::string&& value);
  ...
  // @@protoc_insertion_point(class_scope:im.RadioChat)
 private:
...
class RadioChatAck : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:im.RadioChatAck) */ {
 public:
  RadioChatAck();
  virtual ~RadioChatAck();

  RadioChatAck(const RadioChatAck& from);

  inline RadioChatAck& operator=(const RadioChatAck& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  RadioChatAck(RadioChatAck&& from) noexcept
    : RadioChatAck() {
    *this = ::std::move(from);
  }

  inline RadioChatAck& operator=(RadioChatAck&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const RadioChatAck& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RadioChatAck* internal_default_instance() {
    return reinterpret_cast<const RadioChatAck*>(
               &_RadioChatAck_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    52;

  void Swap(RadioChatAck* other);
  friend void swap(RadioChatAck& a, RadioChatAck& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline RadioChatAck* New() const final {
    return CreateMaybeMessage<RadioChatAck>(NULL);
  }

  RadioChatAck* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RadioChatAck>(arena);
  }
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    final;
  void CopyFrom(const RadioChatAck& from);
  void MergeFrom(const RadioChatAck& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(RadioChatAck* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:im.RadioChatAck)
 private:
...
class RadioCancelChat : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:im.RadioCancelChat) */ {
 public:
  RadioCancelChat();
  virtual ~RadioCancelChat();

  RadioCancelChat(const RadioCancelChat& from);

  inline RadioCancelChat& operator=(const RadioCancelChat& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  RadioCancelChat(RadioCancelChat&& from) noexcept
    : RadioCancelChat() {
    *this = ::std::move(from);
  }

  inline RadioCancelChat& operator=(RadioCancelChat&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const RadioCancelChat& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RadioCancelChat* internal_default_instance() {
    return reinterpret_cast<const RadioCancelChat*>(
               &_RadioCancelChat_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    53;

  void Swap(RadioCancelChat* other);
  friend void swap(RadioCancelChat& a, RadioCancelChat& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline RadioCancelChat* New() const final {
    return CreateMaybeMessage<RadioCancelChat>(NULL);
  }

  RadioCancelChat* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RadioCancelChat>(arena);
  }
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    final;
  void CopyFrom(const RadioCancelChat& from);
  void MergeFrom(const RadioCancelChat& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(RadioCancelChat* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:im.RadioCancelChat)
 private:
...
// string sOperId = 9;
inline void MESAddFriend::clear_soperid() {
  soperid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& MESAddFriend::soperid() const {
  // @@protoc_insertion_point(field_get:im.MESAddFriend.sOperId)
  return soperid_.GetNoArena();
}
inline void MESAddFriend::set_soperid(const ::std::string& value) {
  
  soperid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.MESAddFriend.sOperId)
}
#if LANG_CXX11
inline void MESAddFriend::set_soperid(::std::string&& value) {
  
  soperid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.MESAddFriend.sOperId)
}
#endif
inline void MESAddFriend::set_soperid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  soperid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.MESAddFriend.sOperId)
}
inline void MESAddFriend::set_soperid(const char* value, size_t size) {
  
  soperid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.MESAddFriend.sOperId)
}
inline ::std::string* MESAddFriend::mutable_soperid() {
  
  // @@protoc_insertion_point(field_mutable:im.MESAddFriend.sOperId)
  return soperid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MESAddFriend::release_soperid() {
  // @@protoc_insertion_point(field_release:im.MESAddFriend.sOperId)
  
  return soperid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void MESAddFriend::set_allocated_soperid(::std::string* soperid) {
  if (soperid != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:im.MESAddFriend.sOperId)
}
...
// string sOperId = 9;
inline void MESJoinGrp::clear_soperid() {
  soperid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& MESJoinGrp::soperid() const {
  // @@protoc_insertion_point(field_get:im.MESJoinGrp.sOperId)
  return soperid_.GetNoArena();
}
inline void MESJoinGrp::set_soperid(const ::std::string& value) {
  
  soperid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.MESJoinGrp.sOperId)
}
#if LANG_CXX11
inline void MESJoinGrp::set_soperid(::std::string&& value) {
  
  soperid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.MESJoinGrp.sOperId)
}
#endif
inline void MESJoinGrp::set_soperid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  soperid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.MESJoinGrp.sOperId)
}
inline void MESJoinGrp::set_soperid(const char* value, size_t size) {
  
  soperid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.MESJoinGrp.sOperId)
}
inline ::std::string* MESJoinGrp::mutable_soperid() {
  
  // @@protoc_insertion_point(field_mutable:im.MESJoinGrp.sOperId)
  return soperid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MESJoinGrp::release_soperid() {
  // @@protoc_insertion_point(field_release:im.MESJoinGrp.sOperId)
  
  return soperid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void MESJoinGrp::set_allocated_soperid(::std::string* soperid) {
  if (soperid != NULL) {
  ...
  soperid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), soperid);
  // @@protoc_insertion_point(field_set_allocated:im.MESJoinGrp.sOperId)
}
...
// string sFromId = 1;
inline void RadioChat::clear_sfromid() {
  sfromid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChat::sfromid() const {
  // @@protoc_insertion_point(field_get:im.RadioChat.sFromId)
  return sfromid_.GetNoArena();
}
inline void RadioChat::set_sfromid(const ::std::string& value) {
  
  sfromid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChat.sFromId)
}
#if LANG_CXX11
inline void RadioChat::set_sfromid(::std::string&& value) {
  
  sfromid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChat.sFromId)
}
#endif
inline void RadioChat::set_sfromid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  sfromid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChat.sFromId)
}
inline void RadioChat::set_sfromid(const char* value, size_t size) {
  
  sfromid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChat.sFromId)
}
inline ::std::string* RadioChat::mutable_sfromid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChat.sFromId)
  return sfromid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChat::release_sfromid() {
  // @@protoc_insertion_point(field_release:im.RadioChat.sFromId)
  
  return sfromid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChat::set_allocated_sfromid(::std::string* sfromid) {
  if (sfromid != NULL) {
  ...
  sfromid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), sfromid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioChat.sFromId)
}

// string sRadioId = 2;
inline void RadioChat::clear_sradioid() {
  sradioid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChat::sradioid() const {
  // @@protoc_insertion_point(field_get:im.RadioChat.sRadioId)
  return sradioid_.GetNoArena();
}
inline void RadioChat::set_sradioid(const ::std::string& value) {
  
  sradioid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChat.sRadioId)
}
#if LANG_CXX11
inline void RadioChat::set_sradioid(::std::string&& value) {
  
  sradioid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChat.sRadioId)
}
#endif
inline void RadioChat::set_sradioid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  sradioid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChat.sRadioId)
}
inline void RadioChat::set_sradioid(const char* value, size_t size) {
  
  sradioid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChat.sRadioId)
}
inline ::std::string* RadioChat::mutable_sradioid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChat.sRadioId)
  return sradioid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChat::release_sradioid() {
  // @@protoc_insertion_point(field_release:im.RadioChat.sRadioId)
  
  return sradioid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChat::set_allocated_sradioid(::std::string* sradioid) {
  if (sradioid != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:im.RadioChat.sRadioId)
}

// string sMsgId = 3;
inline void RadioChat::clear_smsgid() {
  smsgid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChat::smsgid() const {
  // @@protoc_insertion_point(field_get:im.RadioChat.sMsgId)
  return smsgid_.GetNoArena();
}
inline void RadioChat::set_smsgid(const ::std::string& value) {
  
  smsgid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChat.sMsgId)
}
#if LANG_CXX11
inline void RadioChat::set_smsgid(::std::string&& value) {
  
  smsgid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChat.sMsgId)
}
#endif
inline void RadioChat::set_smsgid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  smsgid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChat.sMsgId)
}
inline void RadioChat::set_smsgid(const char* value, size_t size) {
  
  smsgid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChat.sMsgId)
}
inline ::std::string* RadioChat::mutable_smsgid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChat.sMsgId)
  return smsgid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChat::release_smsgid() {
  // @@protoc_insertion_point(field_release:im.RadioChat.sMsgId)
  
  return smsgid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChat::set_allocated_smsgid(::std::string* smsgid) {
  if (smsgid != NULL) {
  ...
  smsgid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), smsgid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioChat.sMsgId)
}

// uint64 msgTime = 4;
inline void RadioChat::clear_msgtime() {
  msgtime_ = GOOGLE_ULONGLONG(0);
}
inline ::google::protobuf::uint64 RadioChat::msgtime() const {
  // @@protoc_insertion_point(field_get:im.RadioChat.msgTime)
  return msgtime_;
}
inline void RadioChat::set_msgtime(::google::protobuf::uint64 value) {
  
  msgtime_ = value;
  // @@protoc_insertion_point(field_set:im.RadioChat.msgTime)
}

// uint32 encrypt = 5;
inline void RadioChat::clear_encrypt() {
  encrypt_ = 0u;
}
inline ::google::protobuf::uint32 RadioChat::encrypt() const {
  // @@protoc_insertion_point(field_get:im.RadioChat.encrypt)
  return encrypt_;
}
inline void RadioChat::set_encrypt(::google::protobuf::uint32 value) {
  
  encrypt_ = value;
  // @@protoc_insertion_point(field_set:im.RadioChat.encrypt)
}

// string sContent = 6;
inline void RadioChat::clear_scontent() {
  scontent_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChat::scontent() const {
  // @@protoc_insertion_point(field_get:im.RadioChat.sContent)
  return scontent_.GetNoArena();
}
inline void RadioChat::set_scontent(const ::std::string& value) {
  
  scontent_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChat.sContent)
}
#if LANG_CXX11
inline void RadioChat::set_scontent(::std::string&& value) {
  
  scontent_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChat.sContent)
}
#endif
inline void RadioChat::set_scontent(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  scontent_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChat.sContent)
}
inline void RadioChat::set_scontent(const char* value, size_t size) {
  
  scontent_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChat.sContent)
}
inline ::std::string* RadioChat::mutable_scontent() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChat.sContent)
  return scontent_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChat::release_scontent() {
  // @@protoc_insertion_point(field_release:im.RadioChat.sContent)
  
  return scontent_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChat::set_allocated_scontent(::std::string* scontent) {
  if (scontent != NULL) {
  ...
  scontent_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), scontent);
  // @@protoc_insertion_point(field_set_allocated:im.RadioChat.sContent)
}

// string extend = 7;
inline void RadioChat::clear_extend() {
  extend_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChat::extend() const {
  // @@protoc_insertion_point(field_get:im.RadioChat.extend)
  return extend_.GetNoArena();
}
inline void RadioChat::set_extend(const ::std::string& value) {
  
  extend_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChat.extend)
}
#if LANG_CXX11
inline void RadioChat::set_extend(::std::string&& value) {
  
  extend_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChat.extend)
}
#endif
inline void RadioChat::set_extend(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  extend_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChat.extend)
}
inline void RadioChat::set_extend(const char* value, size_t size) {
  
  extend_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChat.extend)
}
inline ::std::string* RadioChat::mutable_extend() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChat.extend)
  return extend_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChat::release_extend() {
  // @@protoc_insertion_point(field_release:im.RadioChat.extend)
  
  return extend_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChat::set_allocated_extend(::std::string* extend) {
  if (extend != NULL) {
  ...
  extend_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), extend);
  // @@protoc_insertion_point(field_set_allocated:im.RadioChat.extend)
}

// string sId = 8;
inline void RadioChat::clear_sid() {
  sid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChat::sid() const {
  // @@protoc_insertion_point(field_get:im.RadioChat.sId)
  return sid_.GetNoArena();
}
inline void RadioChat::set_sid(const ::std::string& value) {
  
  sid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChat.sId)
}
#if LANG_CXX11
inline void RadioChat::set_sid(::std::string&& value) {
  
  sid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChat.sId)
}
#endif
inline void RadioChat::set_sid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  sid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChat.sId)
}
inline void RadioChat::set_sid(const char* value, size_t size) {
  
  sid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChat.sId)
}
inline ::std::string* RadioChat::mutable_sid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChat.sId)
  return sid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChat::release_sid() {
  // @@protoc_insertion_point(field_release:im.RadioChat.sId)
  
  return sid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChat::set_allocated_sid(::std::string* sid) {
  if (sid != NULL) {
  ...
  // @@protoc_insertion_point(field_set_allocated:im.RadioChat.sId)
}

// string sToId = 9;
inline void RadioChat::clear_stoid() {
  stoid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChat::stoid() const {
  // @@protoc_insertion_point(field_get:im.RadioChat.sToId)
  return stoid_.GetNoArena();
}
inline void RadioChat::set_stoid(const ::std::string& value) {
  
  stoid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChat.sToId)
}
#if LANG_CXX11
inline void RadioChat::set_stoid(::std::string&& value) {
  
  stoid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChat.sToId)
}
#endif
inline void RadioChat::set_stoid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  stoid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChat.sToId)
}
inline void RadioChat::set_stoid(const char* value, size_t size) {
  
  stoid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChat.sToId)
}
inline ::std::string* RadioChat::mutable_stoid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChat.sToId)
  return stoid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChat::release_stoid() {
  // @@protoc_insertion_point(field_release:im.RadioChat.sToId)
  
  return stoid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChat::set_allocated_stoid(::std::string* stoid) {
  if (stoid != NULL) {
  ...
  stoid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), stoid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioChat.sToId)
}
...
// string sFromId = 1;
inline void RadioChatAck::clear_sfromid() {
  sfromid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChatAck::sfromid() const {
  // @@protoc_insertion_point(field_get:im.RadioChatAck.sFromId)
  return sfromid_.GetNoArena();
}
inline void RadioChatAck::set_sfromid(const ::std::string& value) {
  
  sfromid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChatAck.sFromId)
}
#if LANG_CXX11
inline void RadioChatAck::set_sfromid(::std::string&& value) {
  
  sfromid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChatAck.sFromId)
}
#endif
inline void RadioChatAck::set_sfromid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  sfromid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChatAck.sFromId)
}
inline void RadioChatAck::set_sfromid(const char* value, size_t size) {
  
  sfromid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChatAck.sFromId)
}
inline ::std::string* RadioChatAck::mutable_sfromid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChatAck.sFromId)
  return sfromid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChatAck::release_sfromid() {
  // @@protoc_insertion_point(field_release:im.RadioChatAck.sFromId)
  
  return sfromid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChatAck::set_allocated_sfromid(::std::string* sfromid) {
  if (sfromid != NULL) {
  ...
  sfromid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), sfromid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioChatAck.sFromId)
}

// string sRadioId = 2;
inline void RadioChatAck::clear_sradioid() {
  sradioid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChatAck::sradioid() const {
  // @@protoc_insertion_point(field_get:im.RadioChatAck.sRadioId)
  return sradioid_.GetNoArena();
}
inline void RadioChatAck::set_sradioid(const ::std::string& value) {
  
  sradioid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChatAck.sRadioId)
}
#if LANG_CXX11
inline void RadioChatAck::set_sradioid(::std::string&& value) {
  
  sradioid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChatAck.sRadioId)
}
#endif
inline void RadioChatAck::set_sradioid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  sradioid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChatAck.sRadioId)
}
inline void RadioChatAck::set_sradioid(const char* value, size_t size) {
  
  sradioid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChatAck.sRadioId)
}
inline ::std::string* RadioChatAck::mutable_sradioid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChatAck.sRadioId)
  return sradioid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChatAck::release_sradioid() {
  // @@protoc_insertion_point(field_release:im.RadioChatAck.sRadioId)
  
  return sradioid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChatAck::set_allocated_sradioid(::std::string* sradioid) {
  if (sradioid != NULL) {
  ...
  sradioid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), sradioid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioChatAck.sRadioId)
}

// string sMsgId = 3;
inline void RadioChatAck::clear_smsgid() {
  smsgid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioChatAck::smsgid() const {
  // @@protoc_insertion_point(field_get:im.RadioChatAck.sMsgId)
  return smsgid_.GetNoArena();
}
inline void RadioChatAck::set_smsgid(const ::std::string& value) {
  
  smsgid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioChatAck.sMsgId)
}
#if LANG_CXX11
inline void RadioChatAck::set_smsgid(::std::string&& value) {
  
  smsgid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioChatAck.sMsgId)
}
#endif
inline void RadioChatAck::set_smsgid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  smsgid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioChatAck.sMsgId)
}
inline void RadioChatAck::set_smsgid(const char* value, size_t size) {
  
  smsgid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioChatAck.sMsgId)
}
inline ::std::string* RadioChatAck::mutable_smsgid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioChatAck.sMsgId)
  return smsgid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioChatAck::release_smsgid() {
  // @@protoc_insertion_point(field_release:im.RadioChatAck.sMsgId)
  
  return smsgid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioChatAck::set_allocated_smsgid(::std::string* smsgid) {
  if (smsgid != NULL) {
  ...
  smsgid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), smsgid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioChatAck.sMsgId)
}

// uint64 msgTime = 4;
inline void RadioChatAck::clear_msgtime() {
  msgtime_ = GOOGLE_ULONGLONG(0);
}
inline ::google::protobuf::uint64 RadioChatAck::msgtime() const {
  // @@protoc_insertion_point(field_get:im.RadioChatAck.msgTime)
  return msgtime_;
}
inline void RadioChatAck::set_msgtime(::google::protobuf::uint64 value) {
  
  msgtime_ = value;
  // @@protoc_insertion_point(field_set:im.RadioChatAck.msgTime)
}

// .im.ErrCode errcode = 5;
inline void RadioChatAck::clear_errcode() {
  errcode_ = 0;
}
inline ::im::ErrCode RadioChatAck::errcode() const {
  // @@protoc_insertion_point(field_get:im.RadioChatAck.errcode)
  return static_cast< ::im::ErrCode >(errcode_);
}
inline void RadioChatAck::set_errcode(::im::ErrCode value) {
  
  errcode_ = value;
  // @@protoc_insertion_point(field_set:im.RadioChatAck.errcode)
}
...
// string sFromId = 1;
inline void RadioCancelChat::clear_sfromid() {
  sfromid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioCancelChat::sfromid() const {
  // @@protoc_insertion_point(field_get:im.RadioCancelChat.sFromId)
  return sfromid_.GetNoArena();
}
inline void RadioCancelChat::set_sfromid(const ::std::string& value) {
  
  sfromid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioCancelChat.sFromId)
}
#if LANG_CXX11
inline void RadioCancelChat::set_sfromid(::std::string&& value) {
  
  sfromid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioCancelChat.sFromId)
}
#endif
inline void RadioCancelChat::set_sfromid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  sfromid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioCancelChat.sFromId)
}
inline void RadioCancelChat::set_sfromid(const char* value, size_t size) {
  
  sfromid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioCancelChat.sFromId)
}
inline ::std::string* RadioCancelChat::mutable_sfromid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioCancelChat.sFromId)
  return sfromid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioCancelChat::release_sfromid() {
  // @@protoc_insertion_point(field_release:im.RadioCancelChat.sFromId)
  
  return sfromid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioCancelChat::set_allocated_sfromid(::std::string* sfromid) {
  if (sfromid != NULL) {
  ...
  sfromid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), sfromid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioCancelChat.sFromId)
}

// string sRadioId = 2;
inline void RadioCancelChat::clear_sradioid() {
  sradioid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioCancelChat::sradioid() const {
  // @@protoc_insertion_point(field_get:im.RadioCancelChat.sRadioId)
  return sradioid_.GetNoArena();
}
inline void RadioCancelChat::set_sradioid(const ::std::string& value) {
  
  sradioid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioCancelChat.sRadioId)
}
#if LANG_CXX11
inline void RadioCancelChat::set_sradioid(::std::string&& value) {
  
  sradioid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioCancelChat.sRadioId)
}
#endif
inline void RadioCancelChat::set_sradioid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  sradioid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioCancelChat.sRadioId)
}
inline void RadioCancelChat::set_sradioid(const char* value, size_t size) {
  
  sradioid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioCancelChat.sRadioId)
}
inline ::std::string* RadioCancelChat::mutable_sradioid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioCancelChat.sRadioId)
  return sradioid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioCancelChat::release_sradioid() {
  // @@protoc_insertion_point(field_release:im.RadioCancelChat.sRadioId)
  
  return sradioid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioCancelChat::set_allocated_sradioid(::std::string* sradioid) {
  if (sradioid != NULL) {
  ...
  sradioid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), sradioid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioCancelChat.sRadioId)
}

// string sMsgId = 3;
inline void RadioCancelChat::clear_smsgid() {
  smsgid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioCancelChat::smsgid() const {
  // @@protoc_insertion_point(field_get:im.RadioCancelChat.sMsgId)
  return smsgid_.GetNoArena();
}
inline void RadioCancelChat::set_smsgid(const ::std::string& value) {
  
  smsgid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioCancelChat.sMsgId)
}
#if LANG_CXX11
inline void RadioCancelChat::set_smsgid(::std::string&& value) {
  
  smsgid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioCancelChat.sMsgId)
}
#endif
inline void RadioCancelChat::set_smsgid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  smsgid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioCancelChat.sMsgId)
}
inline void RadioCancelChat::set_smsgid(const char* value, size_t size) {
  
  smsgid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioCancelChat.sMsgId)
}
inline ::std::string* RadioCancelChat::mutable_smsgid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioCancelChat.sMsgId)
  return smsgid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioCancelChat::release_smsgid() {
  // @@protoc_insertion_point(field_release:im.RadioCancelChat.sMsgId)
  
  return smsgid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioCancelChat::set_allocated_smsgid(::std::string* smsgid) {
  if (smsgid != NULL) {
  ...
  smsgid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), smsgid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioCancelChat.sMsgId)
}

// uint64 msgTime = 4;
inline void RadioCancelChat::clear_msgtime() {
  msgtime_ = GOOGLE_ULONGLONG(0);
}
inline ::google::protobuf::uint64 RadioCancelChat::msgtime() const {
  // @@protoc_insertion_point(field_get:im.RadioCancelChat.msgTime)
  return msgtime_;
}
inline void RadioCancelChat::set_msgtime(::google::protobuf::uint64 value) {
  
  msgtime_ = value;
  // @@protoc_insertion_point(field_set:im.RadioCancelChat.msgTime)
}

// string extend = 5;
inline void RadioCancelChat::clear_extend() {
  extend_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioCancelChat::extend() const {
  // @@protoc_insertion_point(field_get:im.RadioCancelChat.extend)
  return extend_.GetNoArena();
}
inline void RadioCancelChat::set_extend(const ::std::string& value) {
  
  extend_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioCancelChat.extend)
}
#if LANG_CXX11
inline void RadioCancelChat::set_extend(::std::string&& value) {
  
  extend_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioCancelChat.extend)
}
#endif
inline void RadioCancelChat::set_extend(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  extend_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioCancelChat.extend)
}
inline void RadioCancelChat::set_extend(const char* value, size_t size) {
  
  extend_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioCancelChat.extend)
}
inline ::std::string* RadioCancelChat::mutable_extend() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioCancelChat.extend)
  return extend_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioCancelChat::release_extend() {
  // @@protoc_insertion_point(field_release:im.RadioCancelChat.extend)
  
  return extend_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioCancelChat::set_allocated_extend(::std::string* extend) {
  if (extend != NULL) {
  ...
  extend_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), extend);
  // @@protoc_insertion_point(field_set_allocated:im.RadioCancelChat.extend)
}

// string sToId = 6;
inline void RadioCancelChat::clear_stoid() {
  stoid_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& RadioCancelChat::stoid() const {
  // @@protoc_insertion_point(field_get:im.RadioCancelChat.sToId)
  return stoid_.GetNoArena();
}
inline void RadioCancelChat::set_stoid(const ::std::string& value) {
  
  stoid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:im.RadioCancelChat.sToId)
}
#if LANG_CXX11
inline void RadioCancelChat::set_stoid(::std::string&& value) {
  
  stoid_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:im.RadioCancelChat.sToId)
}
#endif
inline void RadioCancelChat::set_stoid(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  stoid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:im.RadioCancelChat.sToId)
}
inline void RadioCancelChat::set_stoid(const char* value, size_t size) {
  
  stoid_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:im.RadioCancelChat.sToId)
}
inline ::std::string* RadioCancelChat::mutable_stoid() {
  
  // @@protoc_insertion_point(field_mutable:im.RadioCancelChat.sToId)
  return stoid_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* RadioCancelChat::release_stoid() {
  // @@protoc_insertion_point(field_release:im.RadioCancelChat.sToId)
  
  return stoid_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void RadioCancelChat::set_allocated_stoid(::std::string* stoid) {
  if (stoid != NULL) {
  ...
  stoid_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), stoid);
  // @@protoc_insertion_point(field_set_allocated:im.RadioCancelChat.sToId)
}
