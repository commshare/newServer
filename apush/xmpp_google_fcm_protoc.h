/**
* file: F:\Server\src\apush\xmpp_google_fcm_protoc.h
* 日期:2017-8-28-17:29
* 作者:jobs
**/

#ifndef XMPP_GOOGLE_FCM_PROTOC_H
#define XMPP_GOOGLE_FCM_PROTOC_H
...
class CXmppFcmProtoc
{
public:
	CXmppFcmProtoc(im::ANDPushMsg *pPbMsg);
