...
{
public:
	CLoginInfo(const std::string& status, const std::string& cmIp, const std::string& cmPort, const std::string& deviceToken, USER_CALL_STATE callState = USER_CALL_STATE_IDEL);
	~CLoginInfo();
