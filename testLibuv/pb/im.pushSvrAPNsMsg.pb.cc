...
PSvrMsg::PSvrMsg(const PSvrMsg& from)
  ...
  ::memcpy(&emsgtype_, &from.emsgtype_,
    static_cast<size_t>(reinterpret_cast<char*>(&nunreadnotifymsgcount_) -
    reinterpret_cast<char*>(&emsgtype_)) + sizeof(nunreadnotifymsgcount_));
...
void PSvrMsg::SharedCtor() {
  ...
  ::memset(&emsgtype_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&nunreadnotifymsgcount_) -
      reinterpret_cast<char*>(&emsgtype_)) + sizeof(nunreadnotifymsgcount_));
}
